...
-- -----------------------------------------------------
-- Table `mydb`.`TIPO_BLOQUE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TIPO_BLOQUE` (
  `id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`BLOQUES` (
  ...
  CONSTRAINT `fk_BLOQUES_TIPO_BLOQUE1`
    ...
    REFERENCES `mydb`.`TIPO_BLOQUE` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `mydb`.`CURSOS_has_USUARIOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`CURSOS_has_USUARIOS` (
...
-- -----------------------------------------------------
-- Table `mydb`.`UNIDADES_has_CURSOS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`UNIDADES_has_CURSOS` (
  `UNIDADES_id` INT(11) NOT NULL,
  `CURSOS_id` INT(11) NOT NULL,
